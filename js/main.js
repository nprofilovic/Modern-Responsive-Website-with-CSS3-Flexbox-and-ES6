(() => {
    ...
    const reorderResponsiveMenu = () => {
        ...
        if(pageWith <= mobileWidth && navigation) {
            document.body.insertAdjacentElement("afterbegin", navigation);
        }else if (pageWith > mobileWidth && mobileNavigation) {
    ...
    const galleryImageOpen = image => {
        ...
        const openImage = `<div class='aw-backdrop'><img src='${imageSrc}' alt='' />
